...
### Recent software-path results (Silesia)

KV microbench (`run_kv_bench.sh`, occ=50%, blocks=4096, QPL=software):
...
Tree `tail_latency_compare` (`run_tail_latency_sizes.sh`, read-only p50, throughput Mops/s):
